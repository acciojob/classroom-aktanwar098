...
public class StudentController {
    ...
    public ResponseEntity<String> addStudentTeacherPair(@RequestParam("sName") String student, @RequestParam("tName") String teacher){
        String msg = studentService.addStudentTeacherPair(student,teacher);
    ...
    public ResponseEntity<String> deleteTeacherByName(@RequestParam String teacher){
        String msg = studentService.deleteTeacherByName(teacher);
        return new ResponseEntity<>(teacher + " removed successfully", HttpStatus.CREATED);
    }
    @DeleteMapping("/delete-all-teachers")
    public ResponseEntity<String> deleteAllTeachers(){
        String msg = studentService.deleteAllTeachers();
